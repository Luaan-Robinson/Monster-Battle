...
class UI:
    def __init__(self, monster, player_monsters, simple_surfs, get_input):
        ...
        self.available_monsters = [monster for monster in self.player_monsters if monster != self.monster and monster.health > 0] # excludes currently active monster and dead monsters from choices
        self.switch_index = 0
    ...
    def draw_bar(self, rect, value, max_value):
        ratio = rect.width / max_value # math to see how many pixels 1hp represents
