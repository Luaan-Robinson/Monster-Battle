...
from support import *
from timer import Timer  # Ignore python interpreter warnings here, trust me bro.
from monster import *
...
class Game:
    def __init__(self):
        ...
        self.running = True
        self.import_assets()
        self.audio['music'].set_volume(0.6)
    ...
    def player_turn(self):
        ...
        if self.monster.health <= 0:
            ...
            if available_monsters:
                ...
                self.running = False # ends game if all playermonsters are dead     
